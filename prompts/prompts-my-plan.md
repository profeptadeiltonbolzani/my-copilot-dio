...
**Ferramentas comuns (assumir como padrão):** npm / npm / ReactNative, Expo, NESTJS, Express (quando aplicável), testes com Jest/Vitest, lint com ESLint, formatação com Prettier.
...
## DIRETRIZES PARA PLAN EM NODE/JAVASCRIPT/TYPESCRIPT
